...
**Series:** SPIKE Prime Robotics Camp (Session 3 of 5)
...
* **Catch-up:** quick recap of driving (`straight`/`turn`) and the maze from Session 2, so late arrivals can connect, drive, and turn
