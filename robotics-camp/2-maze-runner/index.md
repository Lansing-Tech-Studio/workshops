...
**Series:** SPIKE Prime Robotics Camp (Session 2 of 5)
...
* **Robot:** the same pre-built two-motor driving base from Session 1, with its calibrated `wheel_diameter` / `axle_track` values (instructor flashed the firmware once — see the [Setup & Firmware Guide]({{ site.baseurl }}/robotics-camp/instructor-notes/setup-and-firmware))
