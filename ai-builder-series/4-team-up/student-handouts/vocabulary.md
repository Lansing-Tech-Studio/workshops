...
- Put the collaboration workflow in order (number them 1-6): <br>
  ...
  <span class="blank-line-short"></span> Build your feature

- True or False:
  - You should work directly on the main branch: <span class="blank-line-short"></span>
  - Merge conflicts mean someone made a mistake: <span class="blank-line-short"></span>
  - Code review should be constructive and specific: <span class="blank-line-short"></span>

## Stretch: Write a Review Comment

A teammate added this code to change the quiz title. Write a constructive review
comment:
...
Your comment: <span class="blank-line-long"></span>
